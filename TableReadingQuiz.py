...
class Quiz:
    ...
    def setup_next_question_button(self):
        ...
        self.next_question_button = ctk.CTkButton(self.root, text="Next Question", font=button_font, corner_radius=25, fg_color=purple_color, hover_color=hover_purple_color, command=self.next_question)
    ...
    def check_answer(self): 
        # Print the values on the same line separated by a space, end with a space instead of a newline
        ...
        # Print the list of question answers, start on a new line
        print()  # This will ensure the list of question answers starts on a new line
...
class MainWindow:
    def __init__(self):
        ...
        self.root.title('Table Reading Quiz')
